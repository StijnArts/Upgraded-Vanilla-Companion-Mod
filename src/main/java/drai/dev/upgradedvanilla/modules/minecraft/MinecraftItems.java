...
public class MinecraftItems {
	...
	public static Item torchItem(String woodMaterial, Block torch, Block wallTorch, Item stick, List<TagKey<Item>> itemTags, File out) {
		...
		TextureHelper.addTexture(()->{
			try {
				File leverTextureLocation = RelativeFileHelper.getTemplateData("\\wood\\assets\\textures\\block\\MATERIAL_torch.png");
				...
				File leverOverlay = RelativeFileHelper.getTemplateData("\\wood\\assets\\textures\\overlay\\block\\MATERIAL_torch.png");

...
public class MinecraftItems {
	public static Item stick(String material, TagKey<Item> plankTag, List<TagKey<Item>> itemTags, File out){
		...
		TextureHelper.addTexture(()->{
			File stickTextureLocation = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\item\\MATERIAL_stick.png");
			try {
	...
	public static Item coloredBrick(String material, Item dye, TagKey<Item> brickItems, List<TagKey<Item>> itemTags){
		...
		Item returnItem = ItemHandler.registerItemWithRecipe(material+"_item", sourceCapitalized.trim(),
				new Item(new FabricItemSettings().stacksTo(64).tab(CreativeModeTab.TAB_MATERIALS)),
				(itemModelGenerator,item)->{itemModelGenerator.generateFlatItem(item, ModelTemplates.FLAT_ITEM);},
				(finishedRecipeConsumer, item) -> {
					ShapedRecipeBuilder.shaped(item,4).define('P',brickItems).define('D',dye)
							.pattern("PPP")
							.pattern("PDP")
							.pattern("PPP")
							.unlockedBy("has_"+material, FabricRecipeProvider.has(brickItems)).save(finishedRecipeConsumer);
				},
				itemTags
		);
		return returnItem;
	...
	public static Item signItem(String material, Item stick, Block plankBlock, Block standing, Block wall, TagKey<Item> plankTag, List<TagKey<Item>> itemTags, File out){
		...
		TextureHelper.addTexture(()->{
			try {
				File ladderTextureLocation = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\item\\MATERIAL_sign.png");
				...
				File textTextureLocation = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\overlay\\item\\MATERIAL_sign.png");
	...
	public static Item boatItem(String material, BoatTypeOverride boatTypeOverride, TagKey<Item> plankTag, List<TagKey<Item>> itemTags, File out){
		...
		TextureHelper.addTexture(()->{
			try {
				File boatEntityTexture = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\entity\\boat\\MATERIAL.png");
				File boatTexture = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\item\\MATERIAL_boat.png");
	...
	public static Item chestBoatItem(String material, BoatTypeOverride boatTypeOverride, Item boat, TagKey<Item> chestTag, List<TagKey<Item>> itemTags, File out){
		...
		TextureHelper.addTexture(()->{
			try {
				File boatEntityTexture = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\entity\\chest_boat\\MATERIAL.png");
				File boatItemTexture = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\item\\MATERIAL_chest_boat.png");
				BufferedImage chestBoatTexture = TextureHelper.swapColors("entity\\chest_boat\\"+material, "entity\\chest_boat", UpgradedVanilla.ID,
						ImageIO.read(boatEntityTexture), TextureHelper.woodPresetPalette,out);
				File chestBoatOverlayLocation = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\overlay\\entity\\chest_boat\\MATERIAL.png");
				...
				File chestBoatItemOverlayLocation = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\overlay\\item\\MATERIAL_chest_boat.png");
	...
	public static Item torchItem(String woodMaterial, Block torch, Block wallTorch, Item stick, List<TagKey<Item>> itemTags, File out) {
		...
		TextureHelper.addTexture(()->{
			try {
				File leverTextureLocation = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\block\\MATERIAL_torch.png");
				...
				File leverOverlay = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\overlay\\block\\MATERIAL_torch.png");
	...
	public static Item soulTorchItem(String woodMaterial, Item normalTorch, Block torch, Block wallTorch, Item stick, List<TagKey<Item>> itemTags, File out) {
		...
		TextureHelper.addTexture(()->{
			try {
				File leverTextureLocation = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\block\\MATERIAL_soul_torch.png");
				...
				File leverOverlay = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\overlay\\block\\MATERIAL_soul_torch.png");
	...
	public static Item redstoneTorchItem(String woodMaterial, Block torch, Block wallTorch, Item stick, List<TagKey<Item>> itemTags, File out) {
		...
		TextureHelper.addTexture(()->{
			try {
				File redstoneTorchOnLocation = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\block\\MATERIAL_redstone_torch.png");
				File redstoneTorchOffLocation = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\block\\MATERIAL_redstone_torch_off.png");
				...
				File redstoneTorchOnOverlay = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\overlay\\block\\MATERIAL_redstone_torch.png");
				...
				File redstoneTorchOffOverlay = new File("C:\\Users\\stijn\\Desktop\\Upgraded-Vanilla-Companion-Mod\\src\\main\\resources\\templatedata\\wood\\assets\\textures\\overlay\\block\\MATERIAL_redstone_torch_off.png");

...
public class MinecraftMetalBlocks {
	public static Block metalCutBlock(String material, Block metalBlock, List<TagKey<Block>> blockTags, List<TagKey<Item>> itemTags, File out) {
		...
		TextureHelper.addTexture(() -> {
			try {
				File tileTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\cut_copper.png");
	...
	public static Block lightningRodBlock(String material, Item metalIngot, Block metalBlock, List<TagKey<Block>> blockTags, List<TagKey<Item>> itemTags, File out) {
		...
		TextureHelper.addTexture(() -> {
			try {
				File tileTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\lightning_rod.png");
	...
	public static Block metalChainBlock(String material, Item metalIngot, Item metalNugget, Block metalBlock, List<TagKey<Block>> blockTags, List<TagKey<Item>> itemTags, File out) {
		...
		TextureHelper.addTexture(() -> {
			try {
				File tileTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\chain.png");
				...
				File itemTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\item\\chain.png");
	...
	public static Block hopperBlock(String material, Item metalIngot, Block metalBlock, List<TagKey<Block>> blockTags, List<TagKey<Item>> itemTags, File out) {
		...
		TextureHelper.addTexture(() -> {
			try {
				File insideHopperTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\hopper_inside.png");
				...
				File outsideHopperTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\hopper_outside.png");
				...
				File topHopperTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\hopper_top.png");
				...
				File itemHopperTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\item\\hopper.png");
	...
	public static Block anvilBlock(String material, Item metalIngot, Block metalBlock, TagKey<Item> metalBlockTag, List<TagKey<Block>> blockTags, List<TagKey<Item>> itemTags, File out) {
		...
		TextureHelper.addTexture(() -> {
			try {
				File anvilTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\anvil.png");
				...
				File anvilTopTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\anvil_top.png");
				...
				File chippedAnvilTopTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\chipped_anvil_top.png");
				...
				File damagedAnvilTopTexture = RelativeFileHelper.getTemplateData("\\Metal\\Textures\\damaged_anvil_top.png");

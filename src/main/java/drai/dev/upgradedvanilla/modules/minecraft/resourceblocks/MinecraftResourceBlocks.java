...
public class MinecraftResourceBlocks {
	public static Block resourceStairsBlock(String material, Block woolBlock, TagKey<Item> plankTag, List<TagKey<Block>> blockTags,
										List<TagKey<Item>> itemTags) {
		String sourceCapitalized = "";
		for (String segment : Registry.BLOCK.getKey(woolBlock).getPath().split("_")) {
	...
	public static Block resourceSlabBlock(String material, Block woolBlock, TagKey<Item> plankTag, List<TagKey<Block>> blockTags,
									  List<TagKey<Item>> itemTags) {
		String sourceCapitalized = "";
		for (String segment : Registry.BLOCK.getKey(woolBlock).getPath().split("_")) {
			sourceCapitalized = sourceCapitalized +" "+ StringUtil.capitalizeWord(segment);
	...
	public static Block resourceWallBlock(String material, Block woolBlock, TagKey<Item> blockTag, List<TagKey<Block>> blockTags,
									  List<TagKey<Item>> itemTags) {
		String sourceCapitalized = "";
		for (String segment :Registry.BLOCK.getKey(woolBlock).getPath().split("_")) {
			sourceCapitalized = sourceCapitalized +" "+StringUtil.capitalizeWord(segment);
